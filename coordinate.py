...
class CoordinatePowerLaw(Coordinate):
    ...
    def __init__(self,
        ...
        self.grid = np.linspace(lower_bound**(1/self.growth_rate),
                                upper_bound**(1/self.growth_rate),
                                size)**self.growth_rate
...
class CoordinateTwoLinear(Coordinate):
    ...
    def __init__(self,
        ...
        self.size1 = size1
        self.size2 = size2
        self.grid = np.concatenate((np.linspace(lower_bound, middle, size1),
                                    np.linspace(middle, upper_bound, size2)))
